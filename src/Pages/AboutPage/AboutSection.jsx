            ...
            <div className="row">
                <div className="col-lg-6 col-md-6 col-sm-12">
                    <div className="ABout-about-me">
                        <p>Hi, I am <span>Kamal Rathore</span></p>
                        <h1>A freelance Web developer</h1>
                        <p className="about-me-des">I am from New Delhi, India. A place of beauty and nature. Since my childhood, i love art and design. I always try to design stuff with my unique point of view. I also love to create things that can be usefull to others.</p>
